...
$db->query("create table Payment (email char(255), card_num int not null, exp_date char(255) not null, cvv int not null, foreign key(email) references Users(email))") or die ($db->error);
