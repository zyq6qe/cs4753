...
<div class="container">
    ...
    <form action="pay.php" method="POST">
        ...
        Shipping: <select class="form-control" name="shipping_method" id="shipping_method" class="required-entry" style="width: 100px; display: inline-block; margin-left: 10px">
            <optgroup label="Free">
